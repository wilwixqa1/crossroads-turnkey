...
- [ ] Google sign-in wallets (Phase 2b, replaces passkeys): Turnkey Google sign-in, one sub-org per user, session key signs requests, sign-up proves key ownership. Client ID and origin setup are in docs/sessions/T03_CONTEXT.md.
